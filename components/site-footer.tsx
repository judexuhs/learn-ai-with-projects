    ...
    <footer className="border-t border-black/[.08] bg-white">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 border-x border-black/[.06] px-5 py-10 text-sm text-neutral-500 sm:flex-row sm:items-center sm:justify-between md:px-8">
        ...
        <div className="flex flex-wrap gap-5">
          ...
          <Link href="/concepts" className="hover:text-slate-900">
            知识专题
          </Link>
          <Link href="/methods" className="hover:text-slate-900">
            学习路径
          </Link>
          <Link href="/projects" className="hover:text-slate-900">
            跟做项目
          </Link>
          <Link href="/demos" className="hover:text-slate-900">
            成品 Demo
          </Link>
          <a
            href="https://github.com/judexuhs/learn-ai-with-projects"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://github.com/judexuhs/learn-ai-with-projects/issues/new"
            target="_blank"
            rel="noreferrer"
            className="hover:text-slate-900"
          >
