...
export default function ConceptsPage() {
  return (
    <main className="consumer-page min-h-dvh">
      <SiteHeader />
      <section className="friendly-page-hero mx-auto grid max-w-6xl gap-10 px-5 pt-20 pb-16 md:grid-cols-[1fr_280px] md:px-8 md:pt-24 md:pb-20">
        <div>
          ...
          <p className="mt-5 text-sm font-medium text-[#5146d8]">知识专题</p>
        </div>
        <div className="friendly-intro-note self-end">
          ...
          <Link prefetch={false} href="/concepts/how-llms-generate" className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-[hsl(212_100%_41%)]">阅读第一篇<ArrowRight className="size-4" /></Link>
        </div>
      </section>
