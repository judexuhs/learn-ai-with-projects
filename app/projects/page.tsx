    ...
    <main className="consumer-page min-h-dvh">
      ...
      <section className="friendly-page-hero mx-auto w-full min-w-0 max-w-5xl overflow-hidden px-5 pt-16 pb-20 md:px-8 md:pt-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-sm font-medium text-[#5146d8]">跟做项目</p>
        </div>

        <Link prefetch={false} href="/demos" className="mt-8 inline-flex items-center gap-2 rounded-xl bg-[#5146d8] px-4 py-2.5 text-sm font-medium text-white shadow-[0_8px_18px_rgba(81,70,216,.2)] hover:bg-[#4036bf]">先体验四个成品 Demo<ArrowRight className="size-4" /></Link>
