...
- **首页新手主线：** `10 分钟入门 → 答案之书 → 选择工具或工作流`。三个步骤必须同时可见，第 1 步拥有唯一主按钮。
- **已有目标旁路：** 工具与工作流入口只出现在新手主线之后，并明确标记为“给已经有经验的人”。
- **知识专题：** 首先只推荐 3 篇入门文章；其余 18 篇按用户正在解决的问题折叠分组，不再要求用户理解“原理层 / 应用层 / 项目层”。
